...
-- Papelera segura: retenciÃ³n de 30 dÃ­as, purga reintentable y acceso por rol.
begin;
...
begin
  if old.eliminado_en is null and new.eliminado_en is not null then
    ...
    if old.purga_iniciada_en is not null then
      raise exception 'No se puede restaurar un documento cuya purga estÃ¡ en proceso'
        using errcode = '55000';
    end if;
